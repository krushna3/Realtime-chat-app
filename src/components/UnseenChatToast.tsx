            ...
            <a
                ...
                <div className='flex items-start'>
                    ...
                    <div className='ml-3 flex-1'>
                        <p className='text-sm font-medium text-gray-900 dark:text-zinc-100'>{senderName}</p>
                        <p className='mt-1 text-sm text-gray-500 dark:text-zinc-400'>{senderMessage}</p>
                    </div>
                </div>
            </a>

            <div className='flex border-l border-gray-200 dark:border-zinc-400'>
                <button
                    onClick={() => toast.dismiss(t.id)}
