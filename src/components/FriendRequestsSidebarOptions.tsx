...
const FriendRequestsSidebarOptions: FC<FriendRequestsSidebarOptionsProps> = ({ sessionId, initialUnseenRequestCount }) => {
    ...
    return (
        <Link
            ...
            className='text-gray-700 dark:text-[#A7A1AB] max-md:dark:text-white hover:text-indigo-600 dark:hover:text-indigo-600 hover:bg-gray-50 dark:hover:bg-[#09090E] group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'>
